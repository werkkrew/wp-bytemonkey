...
?>
<!--[if !IE]>
<html class="no-js non-ie" <?php language_attributes(); ?>> 
<![endif]-->
...
<div id="page" class="hfeed site">
			...
			<div class="container">
				<div class="row">
					<div class="site-navigation-inner col-sm-12">
						...
						<?php bytemonkey_header_menu(); // main navigation ?>
					</div>
				</div>
			</div>
		</nav><!-- .site-navigation -->
	...
	<div id="content" class="site-content">
		...
		<div class="top-section">
			<?php bytemonkey_call_for_action(); ?>
		</div>

		<div class="container main-content-area">
            <?php $layout_class = get_layout_class(); ?>
			<div class="row <?php echo $layout_class; ?>">
				<div class="main-content-inner <?php echo bytemonkey_main_content_bootstrap_classes(); ?>">
				<?php
